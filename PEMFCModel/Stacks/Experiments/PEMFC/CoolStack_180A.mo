...
model CoolStack_180A "Cooled PEMFC stack test model"
  ...
  parameter .Modelica.Units.SI.MassFlowRate m_flow_an_min = 2.475e-4 "Minimum value of anodic gas inlet mass flow rate" annotation(Dialog(group = "Anode side"));
  ...
  parameter .Modelica.Units.SI.Pressure p_an_in = 1.9e5 "Start inlet pressure at anode side" annotation(Dialog(group = "Anode side"));
  parameter .Modelica.Units.SI.Pressure p_an_out = 1.8e5 "Outlet pressure at anode side" annotation(Dialog(group = "Anode side"));
  ...
  parameter .Modelica.Units.SI.MassFraction X_an[Medium_an.nS] = Medium_an.moleToMassFractions({0.648,0.074,0.278,0},Medium_an.MMX) "Anodic gas inlet mass-based composition"  annotation(Dialog(group = "Anode side"));
  
  parameter .Modelica.Units.SI.MassFlowRate m_flow_cath_min = 1.342e-3 "Minimum value of cathodic gas inlet mass flow rate" annotation(Dialog(group = "Cathode side"));
  parameter .Modelica.Units.SI.MassFlowRate m_flow_cath_max = m_flow_an_min "Maximum value of cathodic gas inlet mass flow rate" annotation(Dialog(group = "Cathode side"));
  ...
  parameter .Modelica.Units.SI.MassFraction X_cath[Medium_cath.nS] = Medium_cath.moleToMassFractions({0,0,0.083,0.724,0.193},Medium_cath.MMX) "Cathodic gas inlet mass-based composition" annotation(Dialog(group = "Cathode side"));

  parameter .Modelica.Units.SI.MassFlowRate m_flow_water_min  = 8.25e-2 "Minimum value of water inlet mass flow rate" annotation(Dialog(group = " Cooling"));
