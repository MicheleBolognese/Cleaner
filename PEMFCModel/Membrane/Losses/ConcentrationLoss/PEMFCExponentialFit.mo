...
model PEMFCExponentialFit "PEMFC exponentially-fitted concentration loss"
  ...
  parameter Real m = 3e-4 "Pre-exponential coefficient" annotation(Dialog(group = "Input parameters"));
  parameter Real n = 3.2e-4 "Exponential coefficient" annotation(Dialog(group = "Input parameters"));
