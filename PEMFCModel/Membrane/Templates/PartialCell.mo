...
partial model PartialCell "General fuel cell membrane interface"
  ...
  .Modelica.Units.SI.Temperature T_an[N] "Anodic gas temperature in each node at channel-membrane interface";
  .Modelica.Units.SI.Pressure p_an[N](each start = pstart) "Anodic gas pressure in each node at channel-membrane interface";
  .Modelica.Units.SI.SpecificEnthalpy h_an[N] "Anodic gas specific enthalpy in each node at channel-membrane interface";
  .Modelica.Units.SI.MassFraction X_an[N, nS_an] "Anodic gas mass fractions in each node at channel-membrane interface";
  .Modelica.Units.SI.Temperature T_cath[N] "Cathodic gas temperature in each node at channel-membrane interface";
  .Modelica.Units.SI.Pressure p_cath[N](each start = pstart) "Cathodic gas pressure in each node at channel-membrane interface";
  .Modelica.Units.SI.SpecificEnthalpy h_cath[N] "Cathodic gas specific enthalpy in each node at channel-membrane interface";
  .Modelica.Units.SI.MassFraction X_cath[N, nS_cath] "Cathodic gas mass fractions in each node at channel-membrane interface";
...
protected
  ...
  Medium_an.ThermodynamicState state_an[N] "Anodic gas thermodynamic state in each node at channel-membrane interface";
  Medium_cath.ThermodynamicState state_cath[N] "Cathodic gas thermodynamic state in each node at channel-membrane interface"; 
