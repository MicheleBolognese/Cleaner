...
model DistributedChannel
  ...
  .Modelica.Units.SI.Power checkEnergyBalance[n] 
    "Energy balance check for each control volume, should be zero"
    annotation (Dialog(group="Energy Balance"));
protected
...
equation
  ...
  checkEnergyBalance = dE - (H_flow[1:n] - H_flow[2:n+1] + Q + dEk_flow);
