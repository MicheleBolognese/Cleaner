...
model CoolStack_variablepressure_humidified_PID5_fmu "Cooled PEMFC stack test model"
  ...
  .Modelica.Blocks.Sources.CombiTimeTable flow_rate_an_variation(table = {{0,0},{225,7.397},{450,14.795},{675,19.726},{900,22.192},{1125,29.589},{1350,36.987},{1575,44.384}},tableOnFile = false,columns = {2},offset = {29.59},startTime = 2025) annotation(Placement(transformation(extent = {{-203.48781459666964,24.512185403330363},{-180.51218540333036,47.48781459666964}},origin = {0.0,0.0},rotation = 0.0)));
  .Modelica.Blocks.Sources.CombiTimeTable flow_rate_cath_variation(tableOnFile = false,table = {{0,0},{225,14.808},{450,29.615},{675,39.487},{900,44.423},{1125,59.231},{1350,74.038},{1575,88.846}},offset = {59.23},startTime = 2025,columns = {2}) annotation(Placement(transformation(extent = {{-211.48781459666964,-51.48781459666964},{-188.51218540333036,-28.512185403330363}},origin = {0.0,0.0},rotation = 0.0)));
  ...
  .Modelica.Blocks.Math.Add p_water_out(k2 = -1,k1 = +1) annotation(Placement(transformation(extent = {{62.0,-104.0},{82.0,-84.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .Modelica.Blocks.Interfaces.RealInput j_loss annotation(Placement(transformation(extent = {{-334.0,-59.2},{-294.0,-19.200000000000003}},origin = {0.0,0.0},rotation = 0.0)));
...
end CoolStack_variablepressure_humidified_PID5_fmu;
