...
model CoolStack_variablepressure_humidified_PID5 "Cooled PEMFC stack test model"
  ...
  .Modelica.Blocks.Sources.CombiTimeTable current_variation(tableOnFile = false,table = {{0,1e-2},{225,9},{450,22.5},{675,45},{900,60},{1125,67.5},{1350,90},{1575,112.5},{1800,135},{2025,180},{2250,225},{2475,270},{2700,300},{2925,315},{3150,360},{3375,405},{3600,450}},verboseExtrapolation = false,columns = {2}) annotation(Placement(transformation(extent = {{-50.84161487909551,91.15838512090448},{-37.15838512090449,104.84161487909552}},origin = {0.0,0.0},rotation = 0.0)));
  ...
  .Modelica.Blocks.Sources.CombiTimeTable V_cell_exp(table = {{0,0.969},{225,0.879},{450,0.844},{675,0.809},{900,0.793},{1125,0.791},{1350,0.777},{1575,0.767},{1800,0.762},{2025,0.742},{2250,0.734},{2475,0.718},{2700,0.708},{2925,0.703},{3150,0.687},{3375,0.672},{3600,0.656}},columns = {2}) annotation(Placement(transformation(extent = {{-618.0,92.0},{-598.0,112.0}},origin = {0.0,0.0},rotation = 0.0)));
  .Modelica.Blocks.Sources.CombiTimeTable p_an_variation(startTime = 0,offset = {0},columns = {2},tableOnFile = false,table = {{0,141325.0},{225,141325.0},{450,141325.0},{675,141325.0},{900,141325.0},{1125,151325.0},{1350,151325.0},{1575,151325.0},{1800,191325.0},{2025,191325.0},{2250,221325.0},{2475,221325.0},{2700,221325.0},{2925,221325.0},{3150,221325.0},{3375,221325.0},{3600,221325.0}}) annotation(Placement(transformation(extent = {{-203.49,66.51},{-180.51,89.49}},origin = {0.0,0.0},rotation = 0.0)));
  .Modelica.Blocks.Sources.CombiTimeTable dp_an_variation(table = {{0,4000.00},{225,4000.00},{450,4000.00},{675,4000.00},{900,4000.00},{1125,4000.00},{1350,4000.00},{1575,4000.00},{1800,4000.00},{2025,4000.00},{2250,6666.55},{2475,9333.45},{2700,11111.03},{2925,12000.00},{3150,14666.55},{3375,17333.45},{3600,20000.00}},tableOnFile = false,columns = {2},offset = {0},startTime = 0) annotation(Placement(transformation(extent = {{-147.49,130.51},{-124.51,153.49}},origin = {0.0,0.0},rotation = 0.0)));
  ...
  .Modelica.Blocks.Math.Add p_water_out(k2 = -1,k1 = +1) annotation(Placement(transformation(extent = {{62.0,-104.0},{82.0,-84.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .Modelica.Blocks.Continuous.LimPID PID_c1(controllerType = Modelica.Blocks.Types.SimpleController.P,yMax = 1e-2,yMin = 0.85e-3,k = 1e-4,initType = Modelica.Blocks.Types.Init.InitialState) annotation(Placement(transformation(extent = {{-524.0,92.0},{-504.0,112.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Blocks.Continuous.LimPID PID_j0(controllerType = .Modelica.Blocks.Types.SimpleController.P,yMin = 1,yMax = 10000,k = 1e-1,initType = Modelica.Blocks.Types.Init.InitialState) annotation(Placement(transformation(extent = {{-524.0,26.0},{-504.0,46.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Blocks.Continuous.LimPID PID_j_loss(controllerType = .Modelica.Blocks.Types.SimpleController.P,yMin = 10,yMax = 10000,k = 1e-1,initType = Modelica.Blocks.Types.Init.InitialState) annotation(Placement(transformation(extent = {{-526.0,-32.0},{-506.0,-12.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Blocks.Continuous.LimPID PID_m_conc(controllerType = .Modelica.Blocks.Types.SimpleController.P,yMin = 1e-4,yMax = 1e-2,k = 1e-5,initType = Modelica.Blocks.Types.Init.InitialState) annotation(Placement(transformation(extent = {{-522.0,-100.0},{-502.0,-80.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Blocks.Continuous.LimPID PID_n_conc(controllerType = .Modelica.Blocks.Types.SimpleController.P,yMin = 1e-4,yMax = 1e-2,k = 1e-5,initType = Modelica.Blocks.Types.Init.InitialState) annotation(Placement(transformation(extent = {{-520.0,-166.0},{-500.0,-146.0}},origin = {0.0,0.0},rotation = 0.0)));
...
equation       
  ...
  connect(p_an_variation.y[1],humidification_an.p_in) annotation(Line(points = {{-179.36,78},{-155.47,78},{-155.47,33.79},{-131.57,33.79}},color = {0,0,127}));
  ...
  connect(p_cath_variation.y[1],humidification_cath.p_in) annotation(Line(points = {{-171.36,-112},{-151.47,-112},{-151.47,-14.21},{-131.57,-14.21}},color = {0,0,127}));
  ...
  connect(dp_water.y,p_water_out.u2) annotation(Line(points = {{41,-114},{50.5,-114},{50.5,-100},{60,-100}},color = {0,0,127}));
    connect(p_an_variation.y[1],p_an_out.u2) annotation(Line(points = {{-179.36,78},{-144,78},{-144,122},{-54,122}},color = {0,0,127}));
    connect(dp_an_variation.y[1],p_an_out.u1) annotation(Line(points = {{-123.36,142},{-88.68,142},{-88.68,134},{-54,134}},color = {0,0,127}));
    ...
    connect(V_cell_exp.y[1],PID_c1.u_s) annotation(Line(points = {{-597,102},{-526,102}},color = {0,0,127}));
    connect(gain.y,PID_c1.u_m) annotation(Line(points = {{-593.0207950839253,60},{-514,60},{-514,90}},color = {0,0,127}));
    connect(V_cell_exp.y[1],PID_j0.u_s) annotation(Line(points = {{-597,102},{-561.5,102},{-561.5,36},{-526,36}},color = {0,0,127}));
    ...
    connect(V_cell_exp.y[1],PID_j_loss.u_s) annotation(Line(points = {{-597,102},{-562,102},{-562,-22},{-528,-22}},color = {0,0,127}));
    connect(gain.y,PID_j_loss.u_m) annotation(Line(points = {{-593.0207950839253,60},{-590,60},{-590,-40},{-516,-40},{-516,-34}},color = {0,0,127}));
    connect(gain.y,PID_m_conc.u_m) annotation(Line(points = {{-593.0207950839253,60},{-590,60},{-590,-108},{-512,-108},{-512,-102}},color = {0,0,127}));
    connect(PID_n_conc.u_m,gain.y) annotation(Line(points = {{-510,-168},{-510,-174},{-590,-174},{-590,60},{-593.0207950839253,60}},color = {0,0,127}));
    connect(V_cell_exp.y[1],PID_m_conc.u_s) annotation(Line(points = {{-597,102},{-562,102},{-562,-90},{-524,-90}},color = {0,0,127}));
    connect(V_cell_exp.y[1],PID_n_conc.u_s) annotation(Line(points = {{-597,102},{-562,102},{-562,-156},{-522,-156}},color = {0,0,127}));
...
end CoolStack_variablepressure_humidified_PID5;
